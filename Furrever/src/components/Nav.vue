  ...
  <nav class="navbar navbar-expand-lg sticky-top custom-navbar">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      ...
      <div class="navbar-nav ms-auto p-4 p-lg-0">
        <div v-if="authStore.isAuthenticated && userProfile">
          <router-link class="nav-item nav-link fs-5 d-flex align-items-center" :to="{ name: 'Profile' }">
            <img v-if="userProfile.profile_picture" :src="imageUrl(userProfile.profile_picture)" height="50" width="50" style="border-radius: 50%;" />
