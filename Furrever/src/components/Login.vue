...
.focus-input100::before {
  ...
  transition: all .4s;
  background: #7d896e;
  background: -webkit-linear-gradient(left, #7d896e, #d8ac73, #c4c8b2);
  background: -o-linear-gradient(left, #7d896e, #d8ac73, #c4c8b2);
  background: -moz-linear-gradient(left, #7d896e, #d8ac73, #c4c8b2);
  background: linear-gradient(to right, #7d896e, #d8ac73, #c4c8b2);
}
