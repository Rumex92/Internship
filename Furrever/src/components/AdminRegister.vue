        ...
        <div class="wrap-login100">
          <form class="login100-form validate-form" @submit.prevent="register">
            ...
            <div class="text-center p-t-115">
              <span class="txt1" style="margin-top:10px;">
                Already have an account?
              </span>
              <router-link :to="{ name: 'AdminLogin' }" class="txt2" style="text-decoration: none;">
                Login
              </router-link>
            </div>
          </form>
    ...
    const register = async () => {
      try {
        ...
        if (Object.keys(errors.value).length === 0) {
          const isSuccess = await adminAuthStore.register(name.value, email.value, password.value, confirmPassword.value);
